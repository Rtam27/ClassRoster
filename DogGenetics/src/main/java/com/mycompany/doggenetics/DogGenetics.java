...
//    }
    ...
    public static void main(String[] args) {
        ...
        Map<Integer, String> dogBreeds = new HashMap<Integer, String>(); //created a hashmap to store all 10 dogbreeds with a integer key from 1-10
        int totalPerc = 100;
        int currentBreed;
...
//                 for generating a random number from 1-100
        ...
        while (successfulTries < 5) { // while loop to generate 5 unique breeds 
...
//                        System.out.println(check);
                ...
                continue; // probably does not need this else statement
            }
